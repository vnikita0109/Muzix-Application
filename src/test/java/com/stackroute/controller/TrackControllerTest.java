...
public class TrackControllerTest {
    ...
    public void testFindTrackByName() throws Exception{
        when(trackService.searchTrack(track.getTrackName())).thenReturn(track);
        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/findByName/Spring day")
                .contentType(MediaType.APPLICATION_JSON).content(asJsonString(track)))
    ...
    @Test
    public void testFindTrackByNameFailure() throws Exception{
        when(trackService.searchTrack(track.getTrackName())).thenThrow(TrackNotFoundException.class);
        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/find/trackName")
                .contentType(MediaType.APPLICATION_JSON).content(asJsonString(track)))
    ...
    public void testDeleteTrackFailure() throws Exception{
        ...
        mockMvc.perform(MockMvcRequestBuilders.delete("/api/v1/delete/19")
                .contentType(MediaType.APPLICATION_JSON).content(asJsonString(track)))
                .andExpect(MockMvcResultMatchers.status().isNotFound())
                .andDo(MockMvcResultHandlers.print());
    }
    ...
    public void testUpdateTrack() throws Exception{
        ...
        mockMvc.perform(MockMvcRequestBuilders.put("/api/v1/update/track")
                .contentType(MediaType.APPLICATION_JSON).content(asJsonString(track)))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andDo(MockMvcResultHandlers.print());
